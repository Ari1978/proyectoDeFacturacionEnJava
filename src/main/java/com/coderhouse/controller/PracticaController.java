...
import com.coderhouse.dto.AsignacionCategoriaAPracticaDTO;
...
public class PracticaController {
    ...
    public ResponseEntity<?> getPracticaById(@PathVariable Long practicaId) {
        try {
    ...
    public ResponseEntity<?> asignarCategoriaPractica(@RequestBody AsignacionCategoriaAPracticaDTO dto) {
        ...
        try {
            // Llamada al servicio para asignar la categoría a la práctica
            Practica practicaActualizada = practicaService.asignarCategoriaAPractica(
                dto.getPracticaId(),
                dto.getCategoriaId()
            );
            return ResponseEntity.status(HttpStatus.CREATED).body(practicaActualizada); // 201
    ...
    @Operation(summary = "Eliminar una práctica")
    @ApiResponses(value = {
